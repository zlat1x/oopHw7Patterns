...
namespace Builder
{
    class Program
    {
        ...
        class MargaritaPizzaBuilder : PizzaBuilder
        {
            ...
            public override void BuildTopping() { pizza.SetTopping("cheese+basil"); }
        }
        ...
        class BuilderExample
        {
            public static void Main(String[] args)
            {
                ...
                PizzaBuilder margaritaPizzaBuilder = new MargaritaPizzaBuilder(); // added

                // спочатку гавайська, як у прикладі
